...
데이터 파일로 동기화됩니다. ‘시공후기’ 카테고리의 전체 글 수도 함께 집계해
완료 시공 수로 표시하므로 방문자의 Worker 호출 없이 노출됩니다.
...
- `npm run sync:blog`: fetch the latest three Naver posts and completed works count into static data
